...
public class ActivatorTest extends Plugin {
     ...
     * The plug-in ID
     */
    public static final String PLUGIN_ID = "org.eclipse.tracecompass.incubator.gpu.core.tests"; //$NON-NLS-1$
    ...
    public void testActivator() {
        ...
        assertEquals("org.eclipse.tracecompass.incubator.gpu.core", instance.getPluginId());
    }
