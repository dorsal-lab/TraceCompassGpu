...
package org.eclipse.tracecompass.incubator.internal.gpu.core;
...
public class Activator extends TraceCompassActivator {
    ...
    /** The plug-in ID */
    public static final String PLUGIN_ID = "org.eclipse.tracecompass.incubator.gpu.core"; //$NON-NLS-1$
