...
public class GpuBasicBlocksReportDataProviderFactory implements IDataProviderFactory {

    @SuppressWarnings("nls")
    private static final IDataProviderDescriptor DESCRIPTOR = new DataProviderDescriptor.Builder()
            .setId(GpuBasicBlocksReportDataProvider.ID)
            .setName("GPU Basic block data provider")
            .setDescription("GPU Basic block data provider")
            .setProviderType(ProviderType.TREE_TIME_XY)
            .build();

    @Override
    public @Nullable ITmfTreeDataProvider<? extends ITmfTreeDataModel> createProvider(@NonNull ITmfTrace trace) {
        return GpuBasicBlocksReportDataProvider.create(trace);
    }
